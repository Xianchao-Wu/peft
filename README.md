...
6. LazyLoRA: (1) combines prompt tuning, prefix tuning, LoRA, and LLaMA pre-adapter in one framework; (2) use singular values to determine ranks of LoRA (lazy way).
