...
get_ipython().run_cell_magic('time', '', 'pipe = get_lora_sd_pipeline(os.path.join(base_path, "dog_dreambooth_updated"), adapter_name="dog")\n')


# In[5]:


get_ipython().run_cell_magic('time', '', 'load_adapter(pipe, os.path.join(base_path, "toy_dreambooth"), adapter_name="toy")\n')
...
get_ipython().run_cell_magic('time', '', 'set_adapter(pipe, adapter_name="dog")\n')
...
get_ipython().run_cell_magic('time', '', 'set_adapter(pipe, adapter_name="toy")\n')
